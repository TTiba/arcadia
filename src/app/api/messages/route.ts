...
export async function POST(req: NextRequest) {
  ...
  const message = await prisma.message.create({
    data: { senderId: userId, recipientId, subject, body, parentId: parentId ?? null },
    select: MSG_SELECT,
  })
